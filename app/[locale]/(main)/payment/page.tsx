        ...
        <div className="flex flex-col items-center gap-[50px]">
          <div className="flex flex-col md:flex-row justify-between gap-[30px]">
            <div className="flex flex-col items-center gap-[6px]">
              ...
              {translate.paymentPageBankTitle} 
              </p>
            ...
            <div className="flex flex-col items-center gap-[6px]">
              ...
              <p className="family-medium text-black font-medium">
              {translate.paymentPageCardTitle} 
              </p>
              <p className="text-gray/500 text-center text-[13px]">
            ...
            <div className="flex flex-col items-center gap-[6px]">
              <Icons id="paperIcon" />
              <p className="family-medium text-black font-medium">
              {translate.paymentPageCheckTitle} 
              </p>
              <p className="text-gray/500 text-center text-[13px]">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-[50px]">
            <div className="flex flex-col items-center gap-[6px]">
              <Icons id="cryptoIcon" />
              <p className="family-medium text-black font-medium">
              {translate.paymentPageCryptoTitle} 
              </p>
              <p className="text-gray/500 text-center text-[13px]">
            ...
            <div className="flex flex-col items-center gap-[6px]">
              <Icons id="linkIcon" />
              <p className="family-medium text-black font-medium">    {translate.paymentPagePayPalTitle}</p>
              <p className="text-gray/500 text-center text-[13px]">
                {translate.paymentPagePayPalText}
              </p>
            </div>
          </div>
        </div>
