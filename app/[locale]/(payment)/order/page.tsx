...
const OrderPage = () => {
  ...
  const renderCurrentStep = () => {
    switch (paymentPageNumber) {
      case 1:
        return <ConfirmOrder selectedPayment={selectedPayment} setSelectedPayment={setSelectedPayment} setOrderId={setOrderId} nextStep={nextStep} key="confirm" />;
      case 2:
        return <PaymentOrder selectedPayment={selectedPayment} prevStep={prevStep} orderId={orderId} key="payment"/>;
      default:
        return <ConfirmOrder selectedPayment={selectedPayment} setSelectedPayment={setSelectedPayment} setOrderId={setOrderId} nextStep={nextStep} key="confirm" />;
    }
  }
