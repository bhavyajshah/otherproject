...
const Filter: FC = () => {
  ...
  const { onSetFilters, areFiltersEqual } =
    useProducts();
  const {
    filters,
    products,
  ...
  const renderFilterOptionsColor = (
    array: { id: number; name: string; color: string }[], // Убедитесь, что array содержит объекты с id и name
  ...
  // useEffect(() => {
  //   console.log("Setting all products from filter");
  //   setAllProducts();
  // }, [setAllProducts]);
      ...
      <div className="rounded-sm md:border-1 border-border md:shadow-md md:px-[24px] lg:px-[65px] lg:py-[25px] md:py-[25px] sm:py-[0px] md:mb-[37px]">
        <div className="flex flex-col md:flex-row gap-[18px]">
          ...
          <div className="w-full flex flex-col gap-[16px]">
            <div className="w-full flex flex-col rounded-sm border-1 border-border py-[24px] px-[18px] filter-block_shadow">
              <h5 className="family-medium mb-[20px]">
            ...
            <div className="flex justify-center gap-[25px]">
              <Button
                ...
                className="showFiltter w-full md:w-full md:max-w-[270px] h-[44px] text-white"
                radius="sm"
              >
              ...
              <Button
                ...
                className="w-full md:w-full md:max-w-[270px] h-[44px] bg-transparent text-black"
                radius="sm"
              >
